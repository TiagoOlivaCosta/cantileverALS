function [rk, x,y, P, S] = cantilever(x,z, u, P, Q, R)
...
% FORCEI OS MODOS REAIS (Leopoldo) parte imaginária despresível 
...
% Matriz rigidez
L = inv(PHI.')*omega_r2*inv(PHI); % Maia & Silva 1998 pg. 83
...
b = [[0,0];[0,1]]; % matriz booleana de aplicação da forca
